...
public class PermanentChannel implements Channel {
    ...
    public PermanentChannel(String name, String nick, String format, String color, boolean shortcut, boolean focus, double distance, boolean crossworlds, int delay, int delayVip, int delayMvp, int delayMvpPlus, double cost, double costVip, double costMvp, double costMvpPlus, boolean show_cost_msg) {
        this.name = name;
        this.nick = nick;
        this.format = format;
