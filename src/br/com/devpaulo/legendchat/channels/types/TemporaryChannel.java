...
public final class TemporaryChannel implements Channel {
    ...
    public TemporaryChannel(String name, String nick, String format, String color, boolean shortcut, boolean focus, double distance, boolean crossworlds, int delay, int delayVip, int delayMvp, int delayMvpPlus, double cost, double costVip, double costMvp, double costMvpPlus, boolean show_cost_msg, Player leader, boolean mod_can_kick, boolean mod_can_invite) {
        this.name = name;
        this.nick = nick;
        this.format = format;
        ...
        this.delayMvp = delayMvp;
        this.delayMvpPlus = delayMvpPlus;
