...
public class TemporaryChannelManager {
	...
	public void createTempChannel(Player leader, String channel_name, String channel_nickname) {
		...
		createTempChannel(new TemporaryChannel(channel_name,channel_nickname,c.getFormat(),c.getStringColor(),c.isShortcutAllowed(),c.isFocusNeeded(),c.getMaxDistance(),c.isCrossworlds(),c.getDelayPerMessage(),c.getDelayPerMessageVip(),c.getDelayPerMessageMvp(),c.getDelayPerMessageMvpPlus(),c.getCostPerMessage(),c.getCostVip(),c.getCostMvp(),c.getCostMvpPlus(),c.showCostMessage(),leader,c.moderatorsCanKick(),c.moderatorsCanInvite()));
	}
